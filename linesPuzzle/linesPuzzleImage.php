...
if(true){
    ...
    $text_bound = imagettfbbox(150, 0, realpath('./arlrdbd.ttf'), 'Lines Puzzle');
    ...
    // Add text to image
    imagettftext($image, 150, 0, $start_x_offset, $start_y_offset, $black, realpath('./arlrdbd.ttf'), 'Lines Puzzle');
}
if(true){
    $image_width = 3508;
    $image_height = 900;
